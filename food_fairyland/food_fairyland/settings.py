"""
Django settings for food_fairyland project.
...
SECRET_KEY = 'ut+a4fgjten7f4aw_ff#1207gf8m8zr_j)nn7l$&th*4-c(8io'
...
ROOT_URLCONF = 'food_fairyland.urls'
...
WSGI_APPLICATION = 'food_fairyland.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'ngdyhfood@163.com'
# 163邮箱SMTP服务器地址
EMAIL_HOST = 'smtp.163.com'
# 发件人的邮箱
EMAIL_HOST_USER = 'ngdyhfood@163.com'
# 发件人邮箱密码
EMAIL_HOST_PASSWORD = 'ngdyh2233'
# tls协议，有True和False两种情况
EMAIL_USE_TLS = True
# 发件人的邮箱
EMAIL_FROM = 'ngdyhfood@163.com'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://192.168.0.102:6379',
        "OPTIONS": {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'fairyland_handler': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(LOG_ROOT, 'fairyland.log'),
            'maxBytes': 1024 * 1024 * 5,
            'backupCount': 5,
            'formatter': 'standard',
        }
    ...
    'loggers': {
        ...
        'fairyland': {
            'handlers': ['fairyland_handler', 'console'],
            'level': 'DEBUG',
            'propagate': False
        },
    }
