...
// Button 1-1
function initBt11() {
  var bt1 = document.querySelectorAll('#component-11')[0];
  var bt1c = document.querySelector('.button__container');
  var $circlesTopLeft = bt1.querySelectorAll('.circle.top-left');
  var $circlesBottomRight = bt1.querySelectorAll('.circle.bottom-right');

  var filter = document.querySelectorAll('#filter-goo-11 feGaussianBlur')[0];
  ...
  bt1.addEventListener('click', function() {
    bt1c.style.filter = 'url(#filter-goo-11)';
    btTl.restart();
  });
}
